...
const HomePage = () => {
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <header
        className={`flex flex-col items-center justify-center text-center py-20 ${theme === "dark"
      ...
      >
        ...
        <button
          className={`mt-6 px-6 py-3 rounded-lg text-lg font-semibold shadow-lg ${theme === "dark"
      ...
      {/* Features Section */}
      <section
        className={`py-16 px-6 md:px-20 ${theme === "dark" ? "bg-gray-800" : "bg-gray-200"
          }`}
      >
      ...
      <section
        className={`py-16 px-6 md:px-20 ${theme === "dark" ? "bg-gray-900" : "bg-gray-100"
          }`}
      >
      ...
      >
        <div className="text-center">
          ...
          <button
            className={`px-8 py-4 rounded-lg text-lg font-semibold shadow-lg ${theme === "dark"
                ? "bg-yellow-300 text-gray-900"
                : "bg-blue-600 text-white"
              }`}
          >
